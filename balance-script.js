...
function onPaymentAmountChange() {
    ...
    document.getElementById('paymentTotal').textContent = '₺' + val.toFixed(2);
...
function handlePayment() {
    ...
    alert(`₺${amount.toFixed(2)} yükleme işlemi başlatılıyor...\n\nÖdeme sağlayıcı entegrasyonu yakında aktif olacaktır.`);
}
...
function handleIban() {
    ...
    const timeMsg = working
        ? 'Bakiyeniz en geç 30 dakika içinde yüklenecektir.'
        : 'Bakiyeniz mesai saatlerinde (Hafta içi 17:00–00:00 / Hafta sonu 7/24) onaylanacaktır.';
    ...
    if (ok) {
        ...
        alert('Dekontunu başarıyla gönderdik!\n\n' + timeMsg);
